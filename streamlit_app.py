...
class Character(GameObject):
    ...
    def __init__(self, x, y, file, hp, gold, alive):
        ...
        """
        base_url = "https://raw.githubusercontent.com/TomJohnH/streamlit-DragonQuest/main/graphics/other/"
...
class InanimateObject(GameObject):
    ...
    def __init__(self, x, y, file, visible):
        ...
        """
        base_url = "https://raw.githubusercontent.com/TomJohnH/streamlit-DragonQuest/main/graphics/tileset/"
        super().__init__(x, y, file, base_url)
